...
export class AuthService implements OnDestroy {
  private readonly apiUrl = `${this.configurations.restUrl}/api/account`;
  ...
  constructor(private router: Router, private http: HttpClient, private configurations: ConfigurationService) {
